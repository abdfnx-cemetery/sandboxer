...
describe("toHaveLength", () => {
  test("asserts true for valid lengths with no negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect([1, 2, 3, 4]).toHaveLength(4)
          rb.expect([]).toHaveLength(0)
        `,
        fakeResponse
      )()
  ...
  test("asserts false for invalid lengths with no negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect([]).toHaveLength(4)
          rb.expect([1, 2, 3, 4]).toHaveLength(0)
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
  ...
  test("asserts false for valid lengths with negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect([1, 2, 3, 4]).not.toHaveLength(4)
          rb.expect([]).not.toHaveLength(0)
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
  ...
  test("asserts true for invalid lengths with negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect([]).not.toHaveLength(4)
          rb.expect([1, 2, 3, 4]).not.toHaveLength(0)
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
  ...
  test("gives error if not called on an array or a string with no negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect(5).toHaveLength(0)
          rb.expect(true).toHaveLength(0)
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
  ...
  test("gives error if not called on an array or a string with negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect(5).not.toHaveLength(0)
          rb.expect(true).not.toHaveLength(0)
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
  ...
  test("gives an error if toHaveLength parameter is not a number without negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect([1, 2, 3, 4]).toHaveLength("a")
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
  ...
  test("gives an error if toHaveLength parameter is not a number with negation", () => {
    return expect(
      execTestScript(
        `
          rb.expect([1, 2, 3, 4]).not.toHaveLength("a")
        `,
        fakeResponse
      )()
    ).resolves.toEqualRight([
